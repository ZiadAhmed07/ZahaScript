        ...
        if(valuePassWord === valuePassWordConf){
            axios({
                ...
                if(res.data.message === "Validation errors"){
                    setLoader(0)
                    return toast.warn("هذا البريد مسجل بالفعل!")
                } else{
                    setLoader(0)
                ...
                console.log(err)
                setLoader(0)
                return toast.error("حدث خطا ما! حاول مجدد")
            })
        } else{
            setLoader(0)
            return toast.warn("تاكد من استخدام نفس كلمه المرور في الخانه")
        }
    }
                ...
                <div className="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    <div className="p-4 sm:p-7">
                        <div className="text-center">
                            <h1 className="block text-2xl font-bold text-gray-800 dark:text-white">انشاء حساب</h1>
                        ...
                        <div className="mt-5">
                            ...
                            <form onSubmit={(e)=>{createAcc(e)}}>
                                <div className="grid gap-y-4">
                                    <div>
                                        <label htmlFor="fullName" className="block text-gray-700 text-sm mb-2 dark:text-white">الاسم كامل</label>
