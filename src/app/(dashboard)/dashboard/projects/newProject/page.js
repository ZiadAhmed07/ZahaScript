...
export default function newProject() {
    ...
    function postData(e) {
        ...
        axios({
            method: 'post',
            url: `${Domin}/api/admin/create/project`,
            headers: {
            ...
            return toast.success("تم اضافه مشروع جديد")
        }).catch((err) => {
            console.log(err)
            setLoader(false)
    ...
    return (
        <div className="bg-gray-700 rounded-md p-6 flex flex-col gap-6">
            ...
            <div className="flex justify-center ">
                <p className="font-bold text-xl">اضافه مشروع جديد </p>
            </div>
            <div>
                <form className="grid grid-cols-1 md:grid-cols-2 gap-4" onSubmit={postData}>
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="w-full flex gap-3 border border-gray-600 border-solid items-center rounded-md overflow-hidden bg-gray-800">
                            ...
                            <input required type={'text'} onChange={(e) => { setData({ ...data, nameProject: e.target.value }) }} className="bg-gray-800 border-none w-full outline-none text-gray-200 px-2" />
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="w-full flex gap-3 border border-gray-600 border-solid items-center rounded-md overflow-hidden bg-gray-800">
                            ...
                            <input required type={'text'} onChange={(e) => { setData({ ...data, skills: e.target.value }) }} className="bg-gray-800 border-none w-full outline-none text-gray-200 px-2" />
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="w-full flex gap-3 border border-gray-600 border-solid items-center rounded-md overflow-hidden bg-gray-800">
                            ...
                            <input required type={'date'} onChange={(e) => { setData({ ...data, startingDate: e.target.value }) }} className="bg-gray-800 border-none w-full outline-none text-gray-200 px-2" />
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="w-full flex gap-3 border border-gray-600 border-solid items-center rounded-md overflow-hidden bg-gray-800">
                            ...
                            <input required type={'date'} onChange={(e) => { setData({ ...data, endingDate: e.target.value }) }} className="bg-gray-800 border-none w-full outline-none text-gray-200 px-2" />
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="w-full flex gap-3 border border-gray-600 border-solid items-center rounded-md overflow-hidden bg-gray-800">
                            ...
                            <input required type={'number'} onChange={(e) => { setData({ ...data, numberOfSales: e.target.value }) }} className="bg-gray-800 border-none w-full outline-none text-gray-200 px-2" />
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="w-full flex gap-3 border border-gray-600 border-solid items-center rounded-md overflow-hidden bg-gray-800">
                            ...
                            <input required type={'number'} onChange={(e) => { setData({ ...data, price: e.target.value }) }} className="bg-gray-800 border-none w-full outline-none text-gray-200 px-2" />
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="w-full flex gap-3 border border-gray-600 border-solid items-center rounded-md overflow-hidden bg-gray-800">
                            ...
                            <input required accept="image/*" multiple type={'file'} onChange={(e) => { setData({ ...data, imgProject: e.target.files}) }} className="bg-gray-800 border-none w-full outline-none text-gray-200 px-2" />
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="w-full flex gap-3 border border-gray-600 border-solid items-center rounded-md overflow-hidden bg-gray-800">
                            ...
                            <input required type={'url'} onChange={(e) => { setData({ ...data, urlProject: e.target.value }) }} className="bg-gray-800 border-none w-full outline-none text-gray-200 px-2" />
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-col gap-2 md:col-start-1 md:col-end-3">
                        ...
                        <div className="w-full flex gap-3 border border-gray-600 border-solid items-center rounded-md overflow-hidden bg-gray-800">
                            <textarea required onChange={(e) => { setData({ ...data, description: e.target.value }) }} className="bg-gray-800 border-none w-full outline-none text-gray-200 p-4 h-48" />
                        </div>
                    </div>
