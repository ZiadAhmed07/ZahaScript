                                    ...
                                    <div key={el.id} className="p-4 bg-gray-700 rounded-md flex flex-col gap-1">
                                        <div className="flex justify-between items-center py-1 px-3 mb-4 ">
                                            ...
                                            <div className="flex gap-3">
                                                ...
                                                <button onClick={()=>{deleteOrder(el.id) ,setOneOrder(el) }} className="bg-gray-600 h-[30px] w-[30px] rounded-full flex items-center justify-center hover:bg-red-300 hover:text-gray-900">
