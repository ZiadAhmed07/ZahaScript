...
export default function Form() {
        ...
        if(userData){
            axios({
                ...
                if(res.data.message === "Job Created Successfully."){
                    ...
                    return toast.success(translation.job.mess.label1)
                }
                else{
                    setLoader(false)
                    return toast.error(translation.job.mess.label2)
                }
            }).catch((err)=>{
                setLoader(false)
                return toast.error(translation.job.mess.label3)
            })
        }
    ...
    return (
        <form onSubmit={postData} className="max-sm:mt-20">
            {funLoader()}
            <div className="mt-8 space-y-4">
                ...
                <div>
                    ...
                    <div className="relative">
                        <input type="text" onChange={(e)=>{setName(e.target.value)}} required id="hs-cover-with-gradient-form-text-1" className="py-3 ps-11 pe-4 block w-full bg-gray-700 border-white/20 text-white placeholder:text-white rounded-lg text-sm focus:border-white/30 focus:ring-white/30 sm:p-4 sm:ps-11" placeholder={translation.job.label2} />
                ...
                <div>
                    ...
                    <div className="relative">
                        <input type="number" onChange={(e)=>{setPhoneNumber(e.target.value)}} required minLength={8} id="hs-cover-with-gradient-form-number-1" className="py-3 ps-11 pe-4 block w-full bg-gray-700 border-white/20 text-white placeholder:text-white rounded-lg text-sm focus:border-white/30 focus:ring-white/30 sm:p-4 sm:ps-11" placeholder={translation.job.label3}/>
                        <div className="absolute inset-y-0 start-0 flex items-center pointer-events-none z-20 ps-4">
                ...
                <div>
                    ...
                    <div className="relative">
                        <input type="text" onChange={(e)=>{setQualification(e.target.value)}} required id="hs-cover-with-gradient-form-text-2" className="py-3 ps-11 pe-4 block w-full bg-gray-700 border-white/20 text-white placeholder:text-white rounded-lg text-sm focus:border-white/30 focus:ring-white/30 sm:p-4 sm:ps-11" placeholder={translation.job.label4} />
                        <div className="absolute inset-y-0 start-0 flex items-center pointer-events-none z-20 ps-4">
                ...
                <div>
                    ...
                    <div className="relative">
                        <input type="text" onChange={(e)=>{setAddress(e.target.value)}} required id="hs-cover-with-gradient-form-text-3" className="py-3 ps-11 pe-4 block w-full bg-gray-700 border-white/20 text-white placeholder:text-white rounded-lg text-sm focus:border-white/30 focus:ring-white/30 sm:p-4 sm:ps-11" placeholder={translation.job.label5} />
                        <div className="absolute inset-y-0 start-0 flex items-center pointer-events-none z-20 ps-4">
                ...
                <div>
                    ...
                    <div className="relative">
                        <input type="number" onChange={(e)=>{setyearsOfExperience(e.target.value)}} required min={0} max={10} id="hs-cover-with-gradient-form-number-2" className="py-3 ps-11 pe-4 block w-full bg-gray-700 border-white/20 text-white placeholder:text-white rounded-lg text-sm focus:border-white/30 focus:ring-white/30 sm:p-4 sm:ps-11" placeholder={translation.job.label6} />
                        <div className="absolute inset-y-0 start-0 flex items-center pointer-events-none z-20 ps-4">
                ...
                <div id="ButSelect">
                    <div className='my-5 '>
                        <Select
                            placeholder={translation.job.label7}
                            defaultValue={jobs}
                            onChange={setJobs}
                            options={options2}
                            isClearable={true}
                    ...
                    <div >
                        <Select
                            required
                            placeholder={translation.job.label8}
                            defaultValue={skills}
                            onChange={setSkills}
                            options={options}
                            isMulti
