      ...
      return (
        <div className="h-[300px] w-full px-10 py-6">
          <div className=" bg-gray-600 w-full h-full rounded-md flex items-center justify-center flex-col gap-3">
            ...
            <p>{translation.user.label1}</p>
            <Link href={`${pathName.slice(0, 3)}/order`} className='text-blue-500 hover:text-gray-100 rounded-md font-blod hover:bg-blue-500 py-2 px-6'>{translation.user.label2}</Link>
          </div>
        </div>
      )
    }
        ...
        <div className="w-full h-full bg-gray-700 rounded-md flex items-center justify-start flex-col ">
          <div className="flex flex-col w-full items-center gap-3">
            ...
            <div className="gap-3 flex justify-center mt-12">
              <Link href={`${pathName.slice(0, 3)}`} className="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                <span>{translation.user.label13}</span>
              </Link>
              <button onClick={() => { FunLogout() }} className="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"> {translation.user.label14}</button>
            </div>
          </div>
    ...
    if (!userData) {
      return (
        <div className="w-full h-screen bg-gray-700 rounded-md flex flex-col gap-3 items-center justify-center ">
          <p className="font-bold text-lg">{translation.user.label15}</p>
          <Link href={`${pathName.slice(0, 3)}/user/login`} className="px-6 py-2 rounded-sm bg-gray-600 hover:bg-gray-500">{translation.user.label16}</Link>
        </div>
      )
    }
  }
